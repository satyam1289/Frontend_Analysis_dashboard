...
var require_d3_cloud = __commonJS({
  "node_modules/d3-cloud/index.js"(exports, module) {
    ...
    module.exports = function() {
      var size = [256, 256], text = cloudText, font = cloudFont, fontSize = cloudFontSize, fontStyle = cloudFontNormal, fontWeight = cloudFontNormal, padding = cloudPadding, spiral = archimedeanSpiral, words = [], timeInterval = Infinity, event2 = dispatch2("word", "end"), timer2 = null, random = Math.random, rotate = () => (~~(random() * 6) - 3) * 30, cloud = {}, canvas = cloudCanvas;
      ...
      cloud.start = function() {
        ...
        function step() {
          ...
          while (Date.now() - start3 < timeInterval && ++i < n2 && timer2) {
            var d2 = data[i];
            d2.x = size[0] * (random() + 0.5) >> 1;
            d2.y = size[1] * (random() + 0.5) >> 1;
      ...
      function place(board, tag, bounds) {
        var perimeter = [{ x: 0, y: 0 }, { x: size[0], y: size[1] }], startX = tag.x, startY = tag.y, maxDelta = Math.sqrt(size[0] * size[0] + size[1] * size[1]), s = spiral(size), dt = random() < 0.5 ? 1 : -1, t4 = -dt, dxdy, dx, dy;
        while (dxdy = s(t4 += dt)) {
          dx = ~~dxdy[0];
          dy = ~~dxdy[1];
...
function timerFlush() {
  ...
  var t4 = taskHead, e2;
  while (t4) {
    if ((e2 = clockNow - t4._time) >= 0) t4._call.call(null, e2);
    t4 = t4._next;
  }
  --frame;
}
...
function rgbConvert(o2) {
  if (!(o2 instanceof Color)) o2 = color2(o2);
...
function rgbConvert2(o2) {
  if (!(o2 instanceof Color2)) o2 = color3(o2);
...
function M() {
  return (M = Object.assign || function(t4) {
    for (var n2 = 1; n2 < arguments.length; n2++) {
      var r2 = arguments[n2];
      for (var e2 in r2) Object.prototype.hasOwnProperty.call(r2, e2) && (t4[e2] = r2[e2]);
    }
    return t4;
...
function A3(t4, n2, r2, e2) {
  if (!n2.sprite) {
    ...
    for (var v = o2.getImageData(0, 0, 2048 / a, 2048 / a).data, g = []; --e2 >= 0; ) if ((n2 = r2[e2]).hasText) {
...
function I(t4, n2, r2) {
  for (var e2, o2 = t4.sprite, a = t4.width >> 5, i = t4.x - (a << 4), u = 127 & i, f = 32 - u, l = t4.y1 - t4.y0, s = (t4.y + t4.y0) * (r2 >>= 5) + (i >> 5), c3 = 0; c3 < l; c3++) {
    e2 = 0;
    for (var h2 = 0; h2 <= a; h2++) if ((e2 << f | (h2 < a ? (e2 = o2[c3 * a + h2]) >>> u : 0)) & n2[s + h2]) return true;
    s += r2;
  }
  return false;
}
...
function U(t4) {
  ...
  (n2 = x ? (function() {
    ...
    function x2(n4, r4, e4) {
      for (var o4, a3, i2, u3, l2, s2 = r4.x, c4 = r4.y, d3 = Math.sqrt(t5[0] * t5[0] + t5[1] * t5[1]), m3 = f2(t5), y2 = h2() < 0.5 ? 1 : -1, p = -y2; (o4 = m3(p += y2)) && (a3 = ~~o4[0], i2 = ~~o4[1], !(Math.min(Math.abs(a3), Math.abs(i2)) >= d3)); ) if (r4.x = s2 + a3, r4.y = c4 + i2, !(r4.x + r4.x0 < 0 || r4.y + r4.y0 < 0 || r4.x + r4.x1 > t5[0] || r4.y + r4.y1 > t5[1] || e4 && I(r4, n4, t5[0]) || e4 && !((u3 = r4).x + u3.x1 > (l2 = e4)[0].x && u3.x + u3.x0 < l2[1].x && u3.y + u3.y1 > l2[0].y && u3.y + u3.y0 < l2[1].y))) {
    ...
    return void 0 === J ? 30 * (~~(6 * Y()) - 3) : (function(t5, n3, r3) {
      ...
      if (1 === t5) e3 = [n3[0]];
        ...
        e3 = [].concat(n3);
        for (var o3 = (n3[1] - n3[0]) / (t5 - 1), a2 = n3[0] + o3; a2 < n3[1]; ) e3.push(a2), a2 += o3;
      }
      return P(e3, r3);
    })(J, K3, Y);
...
function G(i) {
  var f = i.callbacks, l = i.maxWords, s = void 0 === l ? 100 : l, c3 = i.minSize, h2 = i.options, d2 = i.size, m2 = i.words, y = (function(t4, n2) {
    ...
    for (e2 = 0; e2 < a.length; e2++) n2.indexOf(r2 = a[e2]) >= 0 || (o2[r2] = t4[r2]);
    return o2;
